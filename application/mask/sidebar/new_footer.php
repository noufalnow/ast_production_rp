...
<!-- JQUERY JS -->
  ...
  <!-- SIDE-MENU JS -->
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/sidemenu/sidemenu.js"></script>
  ...
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/peitychart/peitychart.init.js"></script>
  <!-- APEXCHART JS -->
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/js/apexcharts.js"></script>

  <!-- INDEX JS -->
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/js/index1.js"></script>
  ...
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/js/custom.js"></script>
    ...
    <!-- CHARTJS CHART JS-->
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/chart/Chart.bundle.js"></script>
    <!-- INTERNAL SELECT2 JS -->
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/select2/select2.full.min.js"></script>

  
    <!-- INTERNAL DATA TABLES JS -->
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/datatable/dataTables.responsive.min.js"></script>

  <!-- ECHART JS-->
  <script src="http://' . $_SERVER['HTTP_HOST'] . '/2024/assets/plugins/echarts/echarts.js"></script>
